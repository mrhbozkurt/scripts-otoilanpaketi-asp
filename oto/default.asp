...
<div align="center">
	<table border="0" cellpadding="0" style="border-collapse: collapse" width="54%" bordercolor="#C0C0C0" id="table1">
		<tr>
			<td>
						...
						<div align="center">
							<table border="0" cellpadding="0" style="border-collapse: collapse" width="100%" height="311" bordercolor="#F7F7F7" id="table11">
								<tr>
									...
									<td valign="top">
									<div align="center">
										<table border="0" cellpadding="0" style="border-collapse: collapse" width="100%" height="131" bordercolor="#F7F7F7" id="table12">
											<tr>
												<td valign="top" height="72" style="padding-top: 4px">
												<p><!--#include file="ust-blog.asp"--></td>
											</tr>
											<tr>
												<td>&nbsp;<!--#include file="vitrin.asp"--></td>
											</tr>
										</table>
									</div>
									</td>
