...
<title>İkinci El Oto İlanları | <%=emrahbozkurt("sitebasligi")%></title>
...
<div align="center">
	<table border="0" cellpadding="0" style="border-collapse: collapse" width="59%" bordercolor="#C0C0C0" id="table1">
		<tr>
			<td>
											...
											<tr>
												...
												<div align="center">
														<table border="1" cellpadding="0" style="border-collapse: collapse" width="98%" height="217" bordercolor="#EEEEEE" id="table13">
															<tr>
																<td bgcolor="#F8F8F8" height="27">&nbsp;<font face="Tahoma" size="2" color="#CC3300">Sıfır 
																Otomobil 
																İlanları</font></td>
															</tr>
															<tr>
...
superstar.open "select * from ilanlar where ikinciel=1 order by id desc",baglanti,1,3
...
<font size="1" face="Arial">
				...
				Sıfır Oto İlan Sayısı :<b>&nbsp;</b></font><b><font color="#CC3300" size="1"><%=superstar.recordcount%>
</font>
<font size="1"></font>
