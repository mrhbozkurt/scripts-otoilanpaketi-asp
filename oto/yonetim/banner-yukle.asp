...
End Function
Yol = "bannerlar" 
izinli = 500000 'Maximum dosya boyut 500 kb
%>
<html>
...
FileName = "bannerlar/" & FileName
response.write(" <br><input ONCLICK=""window.opener.document.bannerlar.banner.value='"&FileName&"';alert('Ýþlem tamam teþekkür ederiz.');JavaScript:onClick=window.close()"" type=button value=""Ýþlemi Bitirmek Ýçin Týklayýnýz"" " & _
FileName & "<BR>")
End Sub 
%>
