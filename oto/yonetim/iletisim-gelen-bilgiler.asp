...
sql = "Select * from iletisim_formu id order by id desc"
...
day = new Date();
id = day.getTime();
eval("page" + id + " = window.open(URL, '" + id + "', 'toolbar=0,scrollbars=0,location=0,statusbar=0,menubar=0,resizable=0,width=700,height=400,left = 0,top = 0');");
}
// End -->
</script>
</head>
...
<table border="0" cellpadding="0" style="border-collapse: collapse" width="97%" bordercolor="#C0C0C0" id="table1" height="23">
		<tr>
			...
			İLETİŞİM FORMUNDAN GELEN BİLGİLER</font></td>
		</tr>
	</table><%
...
<table border="0" cellpadding="0" style="border-collapse: collapse" width="97%" bordercolor="#F4F4F4" id="table2">
	<tr>
		...
		<td width="624"><font size="2" face="Tahoma" color="#333333">&nbsp;</font><font size="2" face="Tahoma" color="#808080"><A HREF="javascript:popUp('iletisim-gelen-ayrinti.asp?iletisim=<%=ali("id")%>')" style="text-decoration: none"><font color="#333333"><%=ali("adsoyad")%></font></A></font></td>
		<td>
		<p align="left"><font size="2" face="Tahoma" color="#CC3300">
		<a href="mrh-modul.asp?process=iletisim-sil&id=<%=ali("id")%>" style="text-decoration: none"><img alt="Sil" border="0" src="images/sil.gif" width="16" height="16"></a></font></td>
	</tr>
</table>
