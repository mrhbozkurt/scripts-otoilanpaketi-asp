...
<title>Otomobil Haberleri | <%=emrahbozkurt("sitebasligi")%></title>
						...
						<div align="center">
							<table border="0" cellpadding="0" style="border-collapse: collapse" width="100%" height="311" bordercolor="#F7F7F7" id="table11">
								<tr>
									...
									<td valign="top">
									<div align="center">
										<table border="0" cellpadding="0" style="border-collapse: collapse" width="97%" height="284" bordercolor="#F7F7F7" id="table12">
											<tr>
												<td height="19">&nbsp;</td>
											</tr>
											<tr>
												<td valign="top">
												<div align="center">
													<table border="0" cellpadding="0" style="border-collapse: collapse" width="98%" height="263" bordercolor="#F7F7F7" id="table13">
														<tr>
															<td width="34">&nbsp;</td>
															<td valign="top"><% if mrh.eof then
response.write(" Otomobil Haberi Bulunamad&#305;!!!")
else
%><%
...
<a href="detay.asp?detaylar=haber&haber_banka_bilgileri=<%=mrh("id")%>" style="text-decoration: none">
												<font size="2">-&nbsp;<%=mrh("baslik")%></font></a><font size="2" face="Tahoma"><br><% mrh.MoveNext
      Next %>
...
<br>
	...
	&nbsp;</font><div align="center">
																<table border="1" cellpadding="0" style="border-collapse: collapse" width="99%" height="22" bordercolor="#E7E7E7" id="table14">
																<tr>
																	<td bgcolor="#F7F7F7">
																	<font face="Tahoma">
																	<font size="2" color="#666666">
																	&nbsp;</font><font size="2" color="#CC3300">Sayfa 
																	:</font><font size="2"><%
for y=1 to sayfa 
if git=y then
response.write y
else
response.write " <a href=""oto-haberleri.asp?git="&y&""">"&y&"</a>&nbsp;|"
end if
next
%></font></font></td>
																</tr>
	...
	<br>
															...
															<font color="#666666">Toplam Haber Say&#305;s&#305; :</font><font color="#CC3300">&nbsp; <%=mrh.recordcount%>
<% end if %>
