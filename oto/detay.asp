...
<title>Otomobil Haberleri | <%=mrh("baslik")%></title>
<meta name="keywords" content="<%=mrh("icerik")%>">
<meta name="description" content="<%=mrh("icerik")%>">
<style type="text/css">
<!--
a {
	font-family: Tahoma;
						...
						<div align="center">
							<table border="0" cellpadding="0" style="border-collapse: collapse" width="100%" height="311" bordercolor="#F7F7F7" id="table11">
								<tr>
									...
									<td valign="top">
									<div align="center">
										<table border="0" cellpadding="0" style="border-collapse: collapse" width="98%" height="70" bordercolor="#F7F7F7" id="table12">
											<tr>
												<td bgcolor="#F7F7F7" height="24">
												<p align="center">
												<font size="2" face="Tahoma" color="#CC3300"> &nbsp;<%=mrh("baslik")%></font><font size="2" face="Tahoma" color="#333333">&nbsp; 
												Haberin Detayı</font></td>
											</tr>
											<tr>
												<td>
												<font size="2" face="Tahoma" color="#666666">&nbsp;<%=mrh("icerik")%></font></td>
											</tr>
										</table><br>
										<table border="0" cellpadding="0" style="border-collapse: collapse" width="98%" height="7" bordercolor="#F7F7F7" id="table13">
											<tr>
												<td>
												<font size="2" face="Tahoma" color="#CC3300">&nbsp;<%=mrh("tarih")%></font></td>
												<td width="142">
												<p align="right">&nbsp;<font size="2" face="Tahoma"><a href="oto-haberleri.asp" style="text-decoration: none">Geri</a></font></td>
											</tr>
										</table>
									</div>
									</td>
